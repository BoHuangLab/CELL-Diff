...
[ -z "${cell_image_ratio}" ] && cell_image_ratio=1.0
...
[ -z "${MASTER_PORT}" ] && MASTER_PORT=10921
...
python -m torch.distributed.run $DISTRIBUTED_ARGS cell_diff/tasks/cell_diff/finetune_opencell.py \
