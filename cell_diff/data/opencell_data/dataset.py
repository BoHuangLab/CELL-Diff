...
from cell_diff.data.opencell_data.img_utils import RandomRotation, replace_outliers
...
class OpenCellLMDBDataset(Dataset):
    ...
    def get_img(self, item):        
        ...
        nucleus_img = nucleus_img.clamp(0, 0.3) / 0.3
    ...
    def collate(self, samples: List[dict]) -> dict:
        return collate_fn(samples, self.vocab, self.args.max_protein_sequence_len, 0)
